...
class NXServer(NXDaemon):
    ...
    def __init__(self, directory=None, server_type=None, nodes=None,
        ...
        self.initialize(directory, server_type, nodes, parallel)
    ...
    def initialize(self, directory, server_type, nodes, parallel):
        ...
        if parallel:
            self.server
        if self.server_settings.has_option('setup', 'parallel'):
